...
export interface Appointment {
  ...
  location?: string; // *** HINZUGEFÜGT: Einfacher Text-Ort (wird in termine/page.tsx verwendet) ***
  description?: string;
  ...
  // *** HINZUGEFÜGT: Für Zu-/Absagen-Funktion ***
  responses?: {
    [userId: string]: {
      status: 'zugesagt' | 'abgesagt' | 'unsicher';
      userId: string;
      timestamp: Timestamp;
      reason?: string; // Optionaler Grund für Absage
    };
  };
  // *** ENDE HINZUGEFÜGT ***
