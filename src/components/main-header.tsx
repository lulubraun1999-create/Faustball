...
import { Instagram, LogOut, User as UserIcon, Volleyball } from "lucide-react";
        ...
        <div className="flex items-center justify-self-end space-x-2">
          ...
          >
            <Button variant="ghost" size="icon">
              <Volleyball className="h-5 w-5 text-foreground/60 hover:text-foreground/80 dark:text-foreground/80 dark:hover:text-foreground" />
